...
//MP3
   ...
   // kernel->currentThread->setRunTime( kernel->currentThread->getRunTime() + 1 );
    //cout << "Thread [" << kernel->currentThread->getID() << "] get Run Time = " << kernel->currentThread->getRunTime() << endl;
//MP3
