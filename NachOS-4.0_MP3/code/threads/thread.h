...
public:
	...
	void setWaitingTime (double t){ waitTime = t;}
	double getWaitingTime (){return waitTime;}
	...
	double getCPUBurst () { return CPUBurst;}
	void updateCPUBurst();
	...
	void setAgingTime(double t){ agingTime = t; }
	double getAgingTime() { return agingTime; }
	void aging();
